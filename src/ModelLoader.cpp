...
int ModelLoaderUpdate(){
    ...
    std::string inputfile = "src/assets/models/bed_double_A.obj";
    ...
    bool success = tinyobj::LoadObj(&attrib, &shapes, &materials, &warn, &err, inputfile.c_str(), "src/assets/models/bed_double_A.mtl");
